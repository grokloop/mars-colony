...
export function createSettlement() {
  ...
  const melt10 = createIceMelt10();
  root.add(melt10);
  colliders.push({ type: "box", x: -10, z: -216, w: 10, d: 8 });
  landmarks.push({ id: "melt10", name: "Spare ice-melt still 10", position: new THREE.Vector3(-10, 4, -216) });

  const melt11 = createIceMelt11();
  root.add(melt11);
  colliders.push({ type: "box", x: -10, z: -230, w: 10, d: 8 });
  landmarks.push({ id: "melt11", name: "Spare ice-melt still 11", position: new THREE.Vector3(-10, 4, -230) });

  const melt12 = createIceMelt12();
  root.add(melt12);
  colliders.push({ type: "box", x: -10, z: -244, w: 10, d: 8 });
  landmarks.push({ id: "melt12", name: "Spare ice-melt still 12", position: new THREE.Vector3(-10, 4, -244) });
  ...
  const shopshear8 = createShopShear8();
  root.add(shopshear8);
  colliders.push({ type: "box", x: 138, z: -1308, w: 10, d: 8 });
  landmarks.push({ id: "shopshear8", name: "Spare workshop shear 8", position: new THREE.Vector3(138, 4, -1308) });

  const shoppress8 = createShopPress8();
  root.add(shoppress8);
  colliders.push({ type: "box", x: 138, z: -1322, w: 10, d: 8 });
  landmarks.push({ id: "shoppress8", name: "Spare workshop press 8", position: new THREE.Vector3(138, 4, -1322) });

  const shopweld8 = createShopWelder8();
  root.add(shopweld8);
  colliders.push({ type: "box", x: 138, z: -1336, w: 10, d: 8 });
  landmarks.push({ id: "shopweld8", name: "Spare workshop welder 8", position: new THREE.Vector3(138, 4, -1336) });

  const shopmill9 = createShopMill9();
  root.add(shopmill9);
  colliders.push({ type: "box", x: 138, z: -1350, w: 10, d: 8 });
  landmarks.push({ id: "shopmill9", name: "Spare workshop mill 9", position: new THREE.Vector3(138, 4, -1350) });

  const shoplathe9 = createShopLathe9();
  root.add(shoplathe9);
  colliders.push({ type: "box", x: 138, z: -1364, w: 10, d: 8 });
  landmarks.push({ id: "shoplathe9", name: "Spare workshop lathe 9", position: new THREE.Vector3(138, 4, -1364) });

  const shopvise9 = createShopVise9();
  root.add(shopvise9);
  colliders.push({ type: "box", x: 138, z: -1378, w: 10, d: 8 });
  landmarks.push({ id: "shopvise9", name: "Spare workshop vise 9", position: new THREE.Vector3(138, 4, -1378) });

  const shopgrind9 = createShopGrinder9();
  root.add(shopgrind9);
  colliders.push({ type: "box", x: 138, z: -1392, w: 10, d: 8 });
  landmarks.push({ id: "shopgrind9", name: "Spare workshop grinder 9", position: new THREE.Vector3(138, 4, -1392) });

  const shophoist9 = createShopHoist9();
  root.add(shophoist9);
  colliders.push({ type: "box", x: 138, z: -1406, w: 10, d: 8 });
  landmarks.push({ id: "shophoist9", name: "Spare workshop hoist 9", position: new THREE.Vector3(138, 4, -1406) });

  const shopair9 = createShopAir9();
  root.add(shopair9);
  colliders.push({ type: "box", x: 138, z: -1420, w: 10, d: 8 });
  landmarks.push({ id: "shopair9", name: "Spare shop-air 9", position: new THREE.Vector3(138, 4, -1420) });

  const shopcrate9 = createShopCrate9();
  root.add(shopcrate9);
  colliders.push({ type: "box", x: 138, z: -1434, w: 10, d: 8 });
  landmarks.push({ id: "shopcrate9", name: "Spare shop crate 9", position: new THREE.Vector3(138, 4, -1434) });

  const shopdrill9 = createShopDrill9();
  root.add(shopdrill9);
  colliders.push({ type: "box", x: 138, z: -1448, w: 10, d: 8 });
  landmarks.push({ id: "shopdrill9", name: "Spare workshop drill 9", position: new THREE.Vector3(138, 4, -1448) });

  const shopband9 = createShopBandsaw9();
  root.add(shopband9);
  colliders.push({ type: "box", x: 138, z: -1462, w: 10, d: 8 });
  landmarks.push({ id: "shopband9", name: "Spare workshop bandsaw 9", position: new THREE.Vector3(138, 4, -1462) });

  const shopshear9 = createShopShear9();
  root.add(shopshear9);
  colliders.push({ type: "box", x: 138, z: -1476, w: 10, d: 8 });
  landmarks.push({ id: "shopshear9", name: "Spare workshop shear 9", position: new THREE.Vector3(138, 4, -1476) });

  const shoppress9 = createShopPress9();
  root.add(shoppress9);
  colliders.push({ type: "box", x: 138, z: -1490, w: 10, d: 8 });
  landmarks.push({ id: "shoppress9", name: "Spare workshop press 9", position: new THREE.Vector3(138, 4, -1490) });

  const shopweld9 = createShopWelder9();
  root.add(shopweld9);
  colliders.push({ type: "box", x: 138, z: -1504, w: 10, d: 8 });
  landmarks.push({ id: "shopweld9", name: "Spare workshop welder 9", position: new THREE.Vector3(138, 4, -1504) });

  const shopmill10 = createShopMill10();
  root.add(shopmill10);
  colliders.push({ type: "box", x: 138, z: -1518, w: 10, d: 8 });
  landmarks.push({ id: "shopmill10", name: "Spare workshop mill 10", position: new THREE.Vector3(138, 4, -1518) });

  const shoplathe10 = createShopLathe10();
  root.add(shoplathe10);
  colliders.push({ type: "box", x: 138, z: -1532, w: 10, d: 8 });
  landmarks.push({ id: "shoplathe10", name: "Spare workshop lathe 10", position: new THREE.Vector3(138, 4, -1532) });

  const shopvise10 = createShopVise10();
  root.add(shopvise10);
  colliders.push({ type: "box", x: 138, z: -1546, w: 10, d: 8 });
  landmarks.push({ id: "shopvise10", name: "Spare workshop vise 10", position: new THREE.Vector3(138, 4, -1546) });

  const shopgrind10 = createShopGrinder10();
  root.add(shopgrind10);
  colliders.push({ type: "box", x: 138, z: -1560, w: 10, d: 8 });
  landmarks.push({ id: "shopgrind10", name: "Spare workshop grinder 10", position: new THREE.Vector3(138, 4, -1560) });

  const shophoist10 = createShopHoist10();
  root.add(shophoist10);
  colliders.push({ type: "box", x: 138, z: -1574, w: 10, d: 8 });
  landmarks.push({ id: "shophoist10", name: "Spare workshop hoist 10", position: new THREE.Vector3(138, 4, -1574) });

  const shopair10 = createShopAir10();
  root.add(shopair10);
  colliders.push({ type: "box", x: 138, z: -1588, w: 10, d: 8 });
  landmarks.push({ id: "shopair10", name: "Spare shop-air 10", position: new THREE.Vector3(138, 4, -1588) });

  const shopcrate10 = createShopCrate10();
  root.add(shopcrate10);
  colliders.push({ type: "box", x: 138, z: -1602, w: 10, d: 8 });
  landmarks.push({ id: "shopcrate10", name: "Spare shop crate 10", position: new THREE.Vector3(138, 4, -1602) });

  const shopdrill10 = createShopDrill10();
  root.add(shopdrill10);
  colliders.push({ type: "box", x: 138, z: -1616, w: 10, d: 8 });
  landmarks.push({ id: "shopdrill10", name: "Spare workshop drill 10", position: new THREE.Vector3(138, 4, -1616) });

  const shopband10 = createShopBandsaw10();
  root.add(shopband10);
  colliders.push({ type: "box", x: 138, z: -1630, w: 10, d: 8 });
  landmarks.push({ id: "shopband10", name: "Spare workshop bandsaw 10", position: new THREE.Vector3(138, 4, -1630) });

  const shopshear10 = createShopShear10();
  root.add(shopshear10);
  colliders.push({ type: "box", x: 138, z: -1644, w: 10, d: 8 });
  landmarks.push({ id: "shopshear10", name: "Spare workshop shear 10", position: new THREE.Vector3(138, 4, -1644) });

  const shoppress10 = createShopPress10();
  root.add(shoppress10);
  colliders.push({ type: "box", x: 138, z: -1658, w: 10, d: 8 });
  landmarks.push({ id: "shoppress10", name: "Spare workshop press 10", position: new THREE.Vector3(138, 4, -1658) });

  const shopweld10 = createShopWelder10();
  root.add(shopweld10);
  colliders.push({ type: "box", x: 138, z: -1672, w: 10, d: 8 });
  landmarks.push({ id: "shopweld10", name: "Spare workshop welder 10", position: new THREE.Vector3(138, 4, -1672) });

  const shopmill11 = createShopMill11();
  root.add(shopmill11);
  colliders.push({ type: "box", x: 138, z: -1686, w: 10, d: 8 });
  landmarks.push({ id: "shopmill11", name: "Spare workshop mill 11", position: new THREE.Vector3(138, 4, -1686) });

  const shoplathe11 = createShopLathe11();
  root.add(shoplathe11);
  colliders.push({ type: "box", x: 138, z: -1700, w: 10, d: 8 });
  landmarks.push({ id: "shoplathe11", name: "Spare workshop lathe 11", position: new THREE.Vector3(138, 4, -1700) });

  const shopvise11 = createShopVise11();
  root.add(shopvise11);
  colliders.push({ type: "box", x: 138, z: -1714, w: 10, d: 8 });
  landmarks.push({ id: "shopvise11", name: "Spare workshop vise 11", position: new THREE.Vector3(138, 4, -1714) });

  const shopgrind11 = createShopGrinder11();
  root.add(shopgrind11);
  colliders.push({ type: "box", x: 138, z: -1728, w: 10, d: 8 });
  landmarks.push({ id: "shopgrind11", name: "Spare workshop grinder 11", position: new THREE.Vector3(138, 4, -1728) });

  const shophoist11 = createShopHoist11();
  root.add(shophoist11);
  colliders.push({ type: "box", x: 138, z: -1742, w: 10, d: 8 });
  landmarks.push({ id: "shophoist11", name: "Spare workshop hoist 11", position: new THREE.Vector3(138, 4, -1742) });

  const shopair11 = createShopAir11();
  root.add(shopair11);
  colliders.push({ type: "box", x: 138, z: -1756, w: 10, d: 8 });
  landmarks.push({ id: "shopair11", name: "Spare shop-air 11", position: new THREE.Vector3(138, 4, -1756) });

  const shopcrate11 = createShopCrate11();
  root.add(shopcrate11);
  colliders.push({ type: "box", x: 138, z: -1770, w: 10, d: 8 });
  landmarks.push({ id: "shopcrate11", name: "Spare shop crate 11", position: new THREE.Vector3(138, 4, -1770) });

  const shopdrill11 = createShopDrill11();
  root.add(shopdrill11);
  colliders.push({ type: "box", x: 138, z: -1784, w: 10, d: 8 });
  landmarks.push({ id: "shopdrill11", name: "Spare workshop drill 11", position: new THREE.Vector3(138, 4, -1784) });

  const shopband11 = createShopBandsaw11();
  root.add(shopband11);
  colliders.push({ type: "box", x: 138, z: -1798, w: 10, d: 8 });
  landmarks.push({ id: "shopband11", name: "Spare workshop bandsaw 11", position: new THREE.Vector3(138, 4, -1798) });

  const shopshear11 = createShopShear11();
  root.add(shopshear11);
  colliders.push({ type: "box", x: 138, z: -1812, w: 10, d: 8 });
  landmarks.push({ id: "shopshear11", name: "Spare workshop shear 11", position: new THREE.Vector3(138, 4, -1812) });

  const shoppress11 = createShopPress11();
  root.add(shoppress11);
  colliders.push({ type: "box", x: 138, z: -1826, w: 10, d: 8 });
  landmarks.push({ id: "shoppress11", name: "Spare workshop press 11", position: new THREE.Vector3(138, 4, -1826) });

  const shopweld11 = createShopWelder11();
  root.add(shopweld11);
  colliders.push({ type: "box", x: 138, z: -1840, w: 10, d: 8 });
  landmarks.push({ id: "shopweld11", name: "Spare workshop welder 11", position: new THREE.Vector3(138, 4, -1840) });
  ...
  const n2h = createHabN2h();
  root.add(n2h);
  colliders.push({ type: "box", x: -130, z: -76, w: 10, d: 8 });
  landmarks.push({ id: "n2h", name: "Spare hab N2 8", position: new THREE.Vector3(-130, 4, -76) });

  const n2i = createHabN2i();
  root.add(n2i);
  colliders.push({ type: "box", x: -142, z: -76, w: 10, d: 8 });
  landmarks.push({ id: "n2i", name: "Spare hab N2 9", position: new THREE.Vector3(-142, 4, -76) });

  const n2j = createHabN2j();
  root.add(n2j);
  colliders.push({ type: "box", x: -154, z: -76, w: 10, d: 8 });
  landmarks.push({ id: "n2j", name: "Spare hab N2 10", position: new THREE.Vector3(-154, 4, -76) });

  const n2k = createHabN2k();
  root.add(n2k);
  colliders.push({ type: "box", x: -166, z: -76, w: 10, d: 8 });
  landmarks.push({ id: "n2k", name: "Spare hab N2 11", position: new THREE.Vector3(-166, 4, -76) });
  ...
  const habh2o8 = createHabWater8();
  root.add(habh2o8);
  colliders.push({ type: "box", x: -118, z: -100, w: 10, d: 8 });
  landmarks.push({ id: "habh2o8", name: "Spare hab water 8", position: new THREE.Vector3(-118, 4, -100) });

  const habh2o9 = createHabWater9();
  root.add(habh2o9);
  colliders.push({ type: "box", x: -130, z: -100, w: 10, d: 8 });
  landmarks.push({ id: "habh2o9", name: "Spare hab water 9", position: new THREE.Vector3(-130, 4, -100) });

  const habh2o10 = createHabWater10();
  root.add(habh2o10);
  colliders.push({ type: "box", x: -142, z: -100, w: 10, d: 8 });
  landmarks.push({ id: "habh2o10", name: "Spare hab water 10", position: new THREE.Vector3(-142, 4, -100) });
...
function createRoads() {
  ...
  const segs = [
    ...
    [138, -1294, 138, -1308, 3.0],
    [138, -1308, 138, -1322, 3.0],
    [138, -1322, 138, -1336, 3.0],
    [-118, -76, -130, -76, 3.0],
    [-106, -100, -118, -100, 3.0],
    [-10, -202, -10, -216, 3.0],
    [138, -1336, 138, -1350, 3.0],
    [138, -1350, 138, -1364, 3.0],
    [138, -1364, 138, -1378, 3.0],
    [138, -1378, 138, -1392, 3.0],
    [138, -1392, 138, -1406, 3.0],
    [138, -1406, 138, -1420, 3.0],
    [138, -1420, 138, -1434, 3.0],
    [138, -1434, 138, -1448, 3.0],
    [138, -1448, 138, -1462, 3.0],
    [138, -1462, 138, -1476, 3.0],
    [138, -1476, 138, -1490, 3.0],
    [138, -1490, 138, -1504, 3.0],
    [-130, -76, -142, -76, 3.0],
    [-142, -76, -154, -76, 3.0],
    [-154, -76, -166, -76, 3.0],
    [-118, -100, -130, -100, 3.0],
...
function createShopShear8() {
  ...
  g.add(mesh(new THREE.BoxGeometry(4.6, 0.18, 0.7), mats.steel, x, y + 1.85, z + 0.4));
  g.add(mesh(new THREE.BoxGeometry(1.4, 1.8, 1.2), mats.steelDark, x - 2.4, y + 1.9, z));
  addCrate(g, 133.8, -1305.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.35, z + 3.7));
  g.add(labelPlane("SHEAR 8", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.9, z + 3.7));
  return g;
}

function createShopPress8() {
  const g = new THREE.Group();
  g.name = "shop-press-8";
  const x = 138;
  const z = -1322;
  ...
  g.add(mesh(new THREE.BoxGeometry(4.2, 0.28, 2.0), mats.steel, x, y + 3.75, z));
  g.add(mesh(new THREE.CylinderGeometry(0.35, 0.35, 1.2, 12), mats.steel, x, y + 2.4, z));
  addCrate(g, 133.8, -1319.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.35, z + 3.7));
  g.add(labelPlane("PRESS 8", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 3.9, z + 3.7));
  return g;
}

function createShopWelder8() {
  const g = new THREE.Group();
  g.name = "shop-welder-8";
  const x = 138;
  const z = -1336;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.8, 1.2, 1.6), mats.steelDark, x + 2.4, y + 0.8, z + 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("WELD 8", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createHabN2h() {
  const g = new THREE.Group();
  g.name = "hab-n2-8";
  const x = -130;
  const z = -76;
  ...
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("N2 8", "#1a2830", "#d6b48a", 2.0, 0.36, x, y + 3.6, z + 3.7));
  addPipeRun(g, [[-118, -76], [-124, -76], [-130, -76]], mats.pipe, 0.1);
  return g;
}

function createHabWater8() {
  const g = new THREE.Group();
  g.name = "hab-water-8";
  const x = -118;
  const z = -100;
  ...
  g.add(mesh(new THREE.BoxGeometry(2.2, 1.4, 1.6), mats.habDark, x, y + 0.9, z + 2.2));
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.35, z + 3.8));
  g.add(labelPlane("HAB H2O 8", "#1a2830", "#d6b48a", 3.2, 0.36, x, y + 3.8, z + 3.8));
  addPipeRun(g, [[-106, -100], [-112, -100], [-118, -100]], mats.pipe, 0.1);
  return g;
}

function createIceMelt10() {
  const g = new THREE.Group();
  g.name = "ice-melt-10";
  const x = -10;
  const z = -216;
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.55, 0.85, 1.6, 10), mats.steelDark, x + 2.2, y + 4.9, z));
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.5, x, y + 4.4, z + 3.7));
  g.add(labelPlane("MELT 10", "#1a2830", "#d6b48a", 2.4, 0.42, x, y + 3.85, z + 3.7));
  addPipeRun(g, [[-10, -202], [-10, -209], [-10, -216]], mats.pipe, 0.1);
  return g;
}

function createShopMill9() {
  const g = new THREE.Group();
  g.name = "shop-mill-9";
  const x = 138;
  const z = -1350;
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.18, 0.18, 1.2, 10), mats.steel, x + 1.2, y + 2.9, z + 0.9));
  g.add(mesh(new THREE.BoxGeometry(2.2, 1.1, 1.6), mats.steelDark, x - 2.4, y + 0.75, z + 1.8));
  addCrate(g, 133.8, -1347.6, 0.12, 0.85);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.25, z + 3.7));
  g.add(labelPlane("MILL 9", "#1a100c", "#d6b48a", 2.0, 0.36, x, y + 3.8, z + 3.7));
  return g;
}

function createShopLathe9() {
  const g = new THREE.Group();
  g.name = "workshop-lathe-9";
  const x = 138;
  const z = -1364;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.5, 1.6, 1.6), mats.steelDark, x - 2.4, y + 1.9, z));
  g.add(mesh(new THREE.BoxGeometry(1.2, 1.1, 1.4), mats.steelDark, x + 2.6, y + 1.65, z));
  addCrate(g, 133.8, -1361.6, 0.12, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("LATHE 9", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createShopVise9() {
  const g = new THREE.Group();
  g.name = "workshop-vise-9";
  const x = 138;
  const z = -1378;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.35, 0.7, 0.9), mats.steel, x + 0.65, y + 1.7, z));
  g.add(mesh(new THREE.BoxGeometry(2.0, 1.3, 1.5), mats.steelDark, x - 2.4, y + 0.85, z + 1.8));
  addCrate(g, 133.8, -1375.4, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.55, z + 3.7));
  g.add(labelPlane("VISE 9", "#1a100c", "#d6b48a", 2.0, 0.36, x, y + 2.1, z + 3.7));
  return g;
}

function createShopGrinder9() {
  const g = new THREE.Group();
  g.name = "workshop-grinder-9";
  const x = 138;
  const z = -1392;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.85, 0.85, 0.35, 14), mats.steelDark, x + 1.6, y + 1.9, z, 0, 0, Math.PI / 2));
  g.add(mesh(new THREE.BoxGeometry(1.6, 1.4, 1.4), mats.steelDark, x - 2.2, y + 1.8, z));
  addCrate(g, 133.6, -1389.4, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("GRIND 9", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createShopHoist9() {
  const g = new THREE.Group();
  g.name = "workshop-hoist-9";
  const x = 138;
  const z = -1406;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.7, 0.5, 0.5), mats.steelDark, x + 5.2, y + 3.5, z));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.85, z + 3.7));
  g.add(labelPlane("HOIST 9", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 2.4, z + 3.7));
  return g;
}

function createShopAir9() {
  const g = new THREE.Group();
  g.name = "workshop-air-9";
  const x = 138;
  const z = -1420;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.22, 1.6, 0.22), mats.steel, x + 3.4, y + 1.0, z - 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.05, z + 3.7));
  g.add(labelPlane("AIR 9", "#1a100c", "#d6b48a", 2.0, 0.36, x, y + 3.6, z + 3.7));
  return g;
}

function createShopCrate9() {
  const g = new THREE.Group();
  g.name = "shop-crate-9";
  const x = 138;
  const z = -1434;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  addCrate(g, 134.4, -1435.8, 0.1, 1.0);
  addCrate(g, 137.2, -1436.2, -0.15, 0.9);
  addCrate(g, 140.6, -1435.4, 0.2, 1.05);
  addCrate(g, 135.0, -1432.4, -0.1, 0.85);
  addCrate(g, 139.4, -1432.2, 0.05, 0.95);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.35, z + 3.7));
  g.add(labelPlane("PARTS 9", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 1.9, z + 3.7));
  return g;
}

function createShopDrill9() {
  const g = new THREE.Group();
  g.name = "shop-drill-9";
  const x = 138;
  const z = -1448;
  ...
  g.add(mesh(new THREE.BoxGeometry(2.4, 0.22, 1.8), mats.steel, x + 0.3, y + 1.55, z));
  g.add(mesh(new THREE.CylinderGeometry(0.12, 0.12, 1.1, 10), mats.steel, x + 0.3, y + 2.2, z));
  addCrate(g, 133.8, -1445.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("DRILL 9", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 3.7, z + 3.7));
  return g;
}

function createShopBandsaw9() {
  const g = new THREE.Group();
  g.name = "shop-bandsaw-9";
  const x = 138;
  const z = -1462;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.22, 2.8, 1.6), mats.steelDark, x + 1.1, y + 2.5, z));
  g.add(mesh(new THREE.BoxGeometry(2.4, 0.12, 0.12), mats.steel, x, y + 3.7, z));
  addCrate(g, 133.8, -1459.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("BAND 9", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 3.7, z + 3.7));
  return g;
}

function createShopShear9() {
  const g = new THREE.Group();
  g.name = "shop-shear-9";
  const x = 138;
  const z = -1476;
  ...
  g.add(mesh(new THREE.BoxGeometry(4.6, 0.18, 0.7), mats.steel, x, y + 1.85, z + 0.4));
  g.add(mesh(new THREE.BoxGeometry(1.4, 1.8, 1.2), mats.steelDark, x - 2.4, y + 1.9, z));
  addCrate(g, 133.8, -1473.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.35, z + 3.7));
  g.add(labelPlane("SHEAR 9", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.9, z + 3.7));
  return g;
}

function createShopPress9() {
  const g = new THREE.Group();
  g.name = "shop-press-9";
  const x = 138;
  const z = -1490;
  ...
  g.add(mesh(new THREE.BoxGeometry(4.2, 0.28, 2.0), mats.steel, x, y + 3.75, z));
  g.add(mesh(new THREE.CylinderGeometry(0.35, 0.35, 1.2, 12), mats.steel, x, y + 2.4, z));
  addCrate(g, 133.8, -1487.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.35, z + 3.7));
  g.add(labelPlane("PRESS 9", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 3.9, z + 3.7));
  return g;
}

function createShopWelder9() {
  const g = new THREE.Group();
  g.name = "shop-welder-9";
  const x = 138;
  const z = -1504;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.8, 1.2, 1.6), mats.steelDark, x + 2.4, y + 0.8, z + 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("WELD 9", "#1a100c", "#d6b48a", 2.4, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createHabN2i() {
  const g = new THREE.Group();
  g.name = "hab-n2-9";
  const x = -142;
  const z = -76;
  ...
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("N2 9", "#1a2830", "#d6b48a", 2.0, 0.36, x, y + 3.6, z + 3.7));
  addPipeRun(g, [[-130, -76], [-136, -76], [-142, -76]], mats.pipe, 0.1);
  return g;
}

function createHabWater9() {
  const g = new THREE.Group();
  g.name = "hab-water-9";
  const x = -130;
  const z = -100;
  ...
  g.add(mesh(new THREE.BoxGeometry(2.2, 1.4, 1.6), mats.habDark, x, y + 0.9, z + 2.2));
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.35, z + 3.8));
  g.add(labelPlane("HAB H2O 9", "#1a2830", "#d6b48a", 3.2, 0.36, x, y + 3.8, z + 3.8));
  addPipeRun(g, [[-118, -100], [-124, -100], [-130, -100]], mats.pipe, 0.1);
  return g;
}

function createIceMelt11() {
  const g = new THREE.Group();
  g.name = "ice-melt-11";
  const x = -10;
  const z = -230;
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.55, 0.85, 1.6, 10), mats.steelDark, x + 2.2, y + 4.9, z));
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.5, x, y + 4.4, z + 3.7));
  g.add(labelPlane("MELT 11", "#1a2830", "#d6b48a", 2.4, 0.42, x, y + 3.85, z + 3.7));
  addPipeRun(g, [[-10, -216], [-10, -223], [-10, -230]], mats.pipe, 0.1);
  return g;
}

function createShopMill10() {
  const g = new THREE.Group();
  g.name = "shop-mill-10";
  const x = 138;
  const z = -1518;
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.18, 0.18, 1.2, 10), mats.steel, x + 1.2, y + 2.9, z + 0.9));
  g.add(mesh(new THREE.BoxGeometry(2.2, 1.1, 1.6), mats.steelDark, x - 2.4, y + 0.75, z + 1.8));
  addCrate(g, 133.8, -1515.6, 0.12, 0.85);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.25, z + 3.7));
  g.add(labelPlane("MILL 10", "#1a100c", "#d6b48a", 2.2, 0.36, x, y + 3.8, z + 3.7));
  return g;
}

function createShopLathe10() {
  const g = new THREE.Group();
  g.name = "workshop-lathe-10";
  const x = 138;
  const z = -1532;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.5, 1.6, 1.6), mats.steelDark, x - 2.4, y + 1.9, z));
  g.add(mesh(new THREE.BoxGeometry(1.2, 1.1, 1.4), mats.steelDark, x + 2.6, y + 1.65, z));
  addCrate(g, 133.8, -1529.6, 0.12, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("LATHE 10", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createShopVise10() {
  const g = new THREE.Group();
  g.name = "workshop-vise-10";
  const x = 138;
  const z = -1546;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.35, 0.7, 0.9), mats.steel, x + 0.65, y + 1.7, z));
  g.add(mesh(new THREE.BoxGeometry(2.0, 1.3, 1.5), mats.steelDark, x - 2.4, y + 0.85, z + 1.8));
  addCrate(g, 133.8, -1543.4, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.55, z + 3.7));
  g.add(labelPlane("VISE 10", "#1a100c", "#d6b48a", 2.2, 0.36, x, y + 2.1, z + 3.7));
  return g;
}

function createShopGrinder10() {
  const g = new THREE.Group();
  g.name = "workshop-grinder-10";
  const x = 138;
  const z = -1560;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.85, 0.85, 0.35, 14), mats.steelDark, x + 1.6, y + 1.9, z, 0, 0, Math.PI / 2));
  g.add(mesh(new THREE.BoxGeometry(1.6, 1.4, 1.4), mats.steelDark, x - 2.2, y + 1.8, z));
  addCrate(g, 133.6, -1557.4, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("GRIND 10", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createShopHoist10() {
  const g = new THREE.Group();
  g.name = "workshop-hoist-10";
  const x = 138;
  const z = -1574;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.7, 0.5, 0.5), mats.steelDark, x + 5.2, y + 3.5, z));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.85, z + 3.7));
  g.add(labelPlane("HOIST 10", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.4, z + 3.7));
  return g;
}

function createShopAir10() {
  const g = new THREE.Group();
  g.name = "workshop-air-10";
  const x = 138;
  const z = -1588;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.22, 1.6, 0.22), mats.steel, x + 3.4, y + 1.0, z - 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.05, z + 3.7));
  g.add(labelPlane("AIR 10", "#1a100c", "#d6b48a", 2.2, 0.36, x, y + 3.6, z + 3.7));
  return g;
}

function createShopCrate10() {
  const g = new THREE.Group();
  g.name = "shop-crate-10";
  const x = 138;
  const z = -1602;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  addCrate(g, 134.4, -1603.8, 0.1, 1.0);
  addCrate(g, 137.2, -1604.2, -0.15, 0.9);
  addCrate(g, 140.6, -1603.4, 0.2, 1.05);
  addCrate(g, 135.0, -1600.4, -0.1, 0.85);
  addCrate(g, 139.4, -1600.2, 0.05, 0.95);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.35, z + 3.7));
  g.add(labelPlane("PARTS 10", "#1a100c", "#d6b48a", 2.8, 0.36, x, y + 1.9, z + 3.7));
  return g;
}

function createShopDrill10() {
  const g = new THREE.Group();
  g.name = "shop-drill-10";
  const x = 138;
  const z = -1616;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(2.4, 0.22, 1.8), mats.steel, x + 0.3, y + 1.55, z));
  g.add(mesh(new THREE.CylinderGeometry(0.12, 0.12, 1.1, 10), mats.steel, x + 0.3, y + 2.2, z));
  addCrate(g, 133.8, -1613.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("DRILL 10", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 3.7, z + 3.7));
  return g;
}

function createShopBandsaw10() {
  const g = new THREE.Group();
  g.name = "shop-bandsaw-10";
  const x = 138;
  const z = -1630;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.22, 2.8, 1.6), mats.steelDark, x + 1.1, y + 2.5, z));
  g.add(mesh(new THREE.BoxGeometry(2.4, 0.12, 0.12), mats.steel, x, y + 3.7, z));
  addCrate(g, 133.8, -1627.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("BAND 10", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 3.7, z + 3.7));
  return g;
}

function createShopShear10() {
  const g = new THREE.Group();
  g.name = "shop-shear-10";
  const x = 138;
  const z = -1644;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(4.6, 0.18, 0.7), mats.steel, x, y + 1.85, z + 0.4));
  g.add(mesh(new THREE.BoxGeometry(1.4, 1.8, 1.2), mats.steelDark, x - 2.4, y + 1.9, z));
  addCrate(g, 133.8, -1641.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.35, z + 3.7));
  g.add(labelPlane("SHEAR 10", "#1a100c", "#d6b48a", 2.8, 0.36, x, y + 2.9, z + 3.7));
  return g;
}

function createShopPress10() {
  const g = new THREE.Group();
  g.name = "shop-press-10";
  const x = 138;
  const z = -1658;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(4.2, 0.28, 2.0), mats.steel, x, y + 3.75, z));
  g.add(mesh(new THREE.CylinderGeometry(0.35, 0.35, 1.2, 12), mats.steel, x, y + 2.4, z));
  addCrate(g, 133.8, -1655.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.35, z + 3.7));
  g.add(labelPlane("PRESS 10", "#1a100c", "#d6b48a", 2.8, 0.36, x, y + 3.9, z + 3.7));
  return g;
}

function createShopWelder10() {
  const g = new THREE.Group();
  g.name = "shop-welder-10";
  const x = 138;
  const z = -1672;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.8, 1.2, 1.6), mats.steelDark, x + 2.4, y + 0.8, z + 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("WELD 10", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createHabN2j() {
  const g = new THREE.Group();
  g.name = "hab-n2-10";
  const x = -154;
  const z = -76;
  ...
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("N2 10", "#1a2830", "#d6b48a", 2.2, 0.36, x, y + 3.6, z + 3.7));
  addPipeRun(g, [[-142, -76], [-148, -76], [-154, -76]], mats.pipe, 0.1);
  return g;
}

function createHabWater10() {
  const g = new THREE.Group();
  g.name = "hab-water-10";
  const x = -142;
  const z = -100;
  ...
  g.add(mesh(new THREE.BoxGeometry(2.2, 1.4, 1.6), mats.habDark, x, y + 0.9, z + 2.2));
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.35, z + 3.8));
  g.add(labelPlane("HAB H2O 10", "#1a2830", "#d6b48a", 3.4, 0.36, x, y + 3.8, z + 3.8));
  addPipeRun(g, [[-130, -100], [-136, -100], [-142, -100]], mats.pipe, 0.1);
  return g;
}

function createIceMelt12() {
  const g = new THREE.Group();
  g.name = "ice-melt-12";
  const x = -10;
  const z = -244;
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.55, 0.85, 1.6, 10), mats.steelDark, x + 2.2, y + 4.9, z));
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.5, x, y + 4.4, z + 3.7));
  g.add(labelPlane("MELT 12", "#1a2830", "#d6b48a", 2.4, 0.42, x, y + 3.85, z + 3.7));
  addPipeRun(g, [[-10, -230], [-10, -237], [-10, -244]], mats.pipe, 0.1);
  return g;
}

function createShopMill11() {
  const g = new THREE.Group();
  g.name = "shop-mill-11";
  const x = 138;
  const z = -1686;
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.18, 0.18, 1.2, 10), mats.steel, x + 1.2, y + 2.9, z + 0.9));
  g.add(mesh(new THREE.BoxGeometry(2.2, 1.1, 1.6), mats.steelDark, x - 2.4, y + 0.75, z + 1.8));
  addCrate(g, 133.8, -1683.6, 0.12, 0.85);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.25, z + 3.7));
  g.add(labelPlane("MILL 11", "#1a100c", "#d6b48a", 2.2, 0.36, x, y + 3.8, z + 3.7));
  return g;
}

function createShopLathe11() {
  const g = new THREE.Group();
  g.name = "workshop-lathe-11";
  const x = 138;
  const z = -1700;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.5, 1.6, 1.6), mats.steelDark, x - 2.4, y + 1.9, z));
  g.add(mesh(new THREE.BoxGeometry(1.2, 1.1, 1.4), mats.steelDark, x + 2.6, y + 1.65, z));
  addCrate(g, 133.8, -1697.6, 0.12, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("LATHE 11", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createShopVise11() {
  const g = new THREE.Group();
  g.name = "workshop-vise-11";
  const x = 138;
  const z = -1714;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.35, 0.7, 0.9), mats.steel, x + 0.65, y + 1.7, z));
  g.add(mesh(new THREE.BoxGeometry(2.0, 1.3, 1.5), mats.steelDark, x - 2.4, y + 0.85, z + 1.8));
  addCrate(g, 133.8, -1711.4, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.55, z + 3.7));
  g.add(labelPlane("VISE 11", "#1a100c", "#d6b48a", 2.2, 0.36, x, y + 2.1, z + 3.7));
  return g;
}

function createShopGrinder11() {
  const g = new THREE.Group();
  g.name = "workshop-grinder-11";
  const x = 138;
  const z = -1728;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.CylinderGeometry(0.85, 0.85, 0.35, 14), mats.steelDark, x + 1.6, y + 1.9, z, 0, 0, Math.PI / 2));
  g.add(mesh(new THREE.BoxGeometry(1.6, 1.4, 1.4), mats.steelDark, x - 2.2, y + 1.8, z));
  addCrate(g, 133.6, -1725.4, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("GRIND 11", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createShopHoist11() {
  const g = new THREE.Group();
  g.name = "workshop-hoist-11";
  const x = 138;
  const z = -1742;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.7, 0.5, 0.5), mats.steelDark, x + 5.2, y + 3.5, z));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.85, z + 3.7));
  g.add(labelPlane("HOIST 11", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.4, z + 3.7));
  return g;
}

function createShopAir11() {
  const g = new THREE.Group();
  g.name = "workshop-air-11";
  const x = 138;
  const z = -1756;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.22, 1.6, 0.22), mats.steel, x + 3.4, y + 1.0, z - 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.05, z + 3.7));
  g.add(labelPlane("AIR 11", "#1a100c", "#d6b48a", 2.2, 0.36, x, y + 3.6, z + 3.7));
  return g;
}

function createShopCrate11() {
  const g = new THREE.Group();
  g.name = "shop-crate-11";
  const x = 138;
  const z = -1770;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  addCrate(g, 134.4, -1771.8, 0.1, 1.0);
  addCrate(g, 137.2, -1772.2, -0.15, 0.9);
  addCrate(g, 140.6, -1771.4, 0.2, 1.05);
  addCrate(g, 135.0, -1768.4, -0.1, 0.85);
  addCrate(g, 139.4, -1768.2, 0.05, 0.95);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 2.35, z + 3.7));
  g.add(labelPlane("PARTS 11", "#1a100c", "#d6b48a", 2.8, 0.36, x, y + 1.9, z + 3.7));
  return g;
}

function createShopDrill11() {
  const g = new THREE.Group();
  g.name = "shop-drill-11";
  const x = 138;
  const z = -1784;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(2.4, 0.22, 1.8), mats.steel, x + 0.3, y + 1.55, z));
  g.add(mesh(new THREE.CylinderGeometry(0.12, 0.12, 1.1, 10), mats.steel, x + 0.3, y + 2.2, z));
  addCrate(g, 133.8, -1781.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("DRILL 11", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 3.7, z + 3.7));
  return g;
}

function createShopBandsaw11() {
  const g = new THREE.Group();
  g.name = "shop-bandsaw-11";
  const x = 138;
  const z = -1798;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(0.22, 2.8, 1.6), mats.steelDark, x + 1.1, y + 2.5, z));
  g.add(mesh(new THREE.BoxGeometry(2.4, 0.12, 0.12), mats.steel, x, y + 3.7, z));
  addCrate(g, 133.8, -1795.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("BAND 11", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 3.7, z + 3.7));
  return g;
}

function createShopShear11() {
  const g = new THREE.Group();
  g.name = "shop-shear-11";
  const x = 138;
  const z = -1812;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(4.6, 0.18, 0.7), mats.steel, x, y + 1.85, z + 0.4));
  g.add(mesh(new THREE.BoxGeometry(1.4, 1.8, 1.2), mats.steelDark, x - 2.4, y + 1.9, z));
  addCrate(g, 133.8, -1809.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.35, z + 3.7));
  g.add(labelPlane("SHEAR 11", "#1a100c", "#d6b48a", 2.8, 0.36, x, y + 2.9, z + 3.7));
  return g;
}

function createShopPress11() {
  const g = new THREE.Group();
  g.name = "shop-press-11";
  const x = 138;
  const z = -1826;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(4.2, 0.28, 2.0), mats.steel, x, y + 3.75, z));
  g.add(mesh(new THREE.CylinderGeometry(0.35, 0.35, 1.2, 12), mats.steel, x, y + 2.4, z));
  addCrate(g, 133.8, -1823.6, 0.1, 0.8);
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 4.35, z + 3.7));
  g.add(labelPlane("PRESS 11", "#1a100c", "#d6b48a", 2.8, 0.36, x, y + 3.9, z + 3.7));
  return g;
}

function createShopWelder11() {
  const g = new THREE.Group();
  g.name = "shop-welder-11";
  const x = 138;
  const z = -1840;
  const y = getHeight(x, z);
  g.add(mesh(new THREE.BoxGeometry(9.6, 0.2, 7.2), mats.concrete, x, y + 0.1, z));
  ...
  g.add(mesh(new THREE.BoxGeometry(1.8, 1.2, 1.6), mats.steelDark, x + 2.4, y + 0.8, z + 1.6));
  g.add(labelPlane("SPARE", "#1a100c", "#f0c089", 2.2, 0.42, x, y + 3.15, z + 3.7));
  g.add(labelPlane("WELD 11", "#1a100c", "#d6b48a", 2.6, 0.36, x, y + 2.7, z + 3.7));
  return g;
}

function createHabN2k() {
  const g = new THREE.Group();
  g.name = "hab-n2-11";
  const x = -166;
  const z = -76;
  ...
  g.add(labelPlane("SPARE", "#1a2830", "#d6e6ef", 2.2, 0.42, x, y + 4.15, z + 3.7));
  g.add(labelPlane("N2 11", "#1a2830", "#d6b48a", 2.2, 0.36, x, y + 3.6, z + 3.7));
  addPipeRun(g, [[-154, -76], [-160, -76], [-166, -76]], mats.pipe, 0.1);
  return g;
}
